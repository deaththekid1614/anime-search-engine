...
const TrendingPage = () => {
  ...
  const fetchTrending = useCallback(async (page = 1, isLoadMore = false) => {
    setLoading(true);
    try {
      const data = await api.getTrending(page, 20);
      if (isLoadMore) {
  ...
  return (
    <div className="min-h-screen bg-anime-darker pt-24 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-anime-text mb-2">Trending Now</h1>
          <p className="text-anime-muted">The most popular anime right now</p>
        </div>
